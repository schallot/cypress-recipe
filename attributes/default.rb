...
default[:cypress][:cqm_execution56_install_path] = '/opt/cqm-execution56-service'
default[:cypress][:cypress_repository] = 'https://dl.packager.io/srv/deb/projectcypress/cypress/cypress_v6/ubuntu'
default[:cypress][:cvu_repository] = 'https://dl.packager.io/srv/deb/projectcypress/cypress-validation-utility/cvu_v5/ubuntu'
default[:cypress][:cqm_execution_repository] = 'https://dl.packager.io/srv/deb/projecttacoma/cqm-execution-service/cypress_v6/ubuntu'
default[:cypress][:cqm_execution56_repository] = 'https://dl.packager.io/srv/deb/luis1van/cqm-execution-service/cypress_qdm_5_6/ubuntu'
...
default[:cypress][:cqm_execution56_repository_key] = 'https://dl.packager.io/srv/luis1van/cqm-execution-service/key'
